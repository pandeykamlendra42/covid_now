      ...
      worldList.data.forEach((covid) {
        _markers.add(Marker(
            infoWindow: InfoWindow(
                anchor: Offset.zero,
                title: "${covid.country}(${covid.confirmed})",
                snippet:
                    "Recovered: ${covid.recovered}, Deaths: ${covid.deaths}"),
